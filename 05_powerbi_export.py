...
# Outputs: powerbi/contributions.csv
#          powerbi/roi_summary.csv
#          powerbi/model_fit.csv
#
# Steps (to implement):
...
def main():
    ...
    contributions.to_csv("powerbi/contributions.csv", index=False)
    roi.to_csv("powerbi/roi_summary.csv", index=False)
    fit.to_csv("powerbi/model_fit.csv", index=False)
    print("Power BI exports saved to powerbi/")
